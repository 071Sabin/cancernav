...
class navpatientcontroller extends Controller
{
    public function patientaccounts()
    {
        $navigator = Auth::user(); // this returns the full Navigator model
        $patients = $navigator->patients; // access the 'patients()' relationship

        // dd($patients);
        return view('navigator.navpatientaccounts', compact('patients'));
    }


    // this will show add patient form
    public function nav_show_addpatient()
    {
        ...
        return view('navigator.navaddpatients', compact('hospitals', 'navigators', 'cancertypes'));
    }
